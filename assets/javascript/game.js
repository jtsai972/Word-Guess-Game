//setting up arrays
    ...
    let wordBank = ["abalone", "algae", "amberjack","anemone", "anglerfish", "barnacle", "barracuda", "blowfish", "clam", "clown fish", "cod", "coelacanth", "conch", "coral", "crab", "currents", "cuddlefish", "dolphin", "eel", "estuary", "fin", "fish", "flounder", "gar", "grouper", "herring", "jellyfish", "kelp", "krill", "limpet", "lobster", "loggerhead", "mackerel", "manatee", "manta", "mollusk", "mussel", "narwhal", "nautilus", "ocean", "octopus", "orca", "otter", "oyster", "phytoplankton", "plankton", "porpoise", "pufferfish", "reef", "sanddollar", "scales", "scallop", "seagull", "seahorse", "seal", "seaweed", "shark", "ship", "shrimp", "squid", "starfish", "stingray", "sunfish", "swordfish", "tidepool", "tsunami", "tuna", "urchin", "walrus", "waves", "whale", "whitecaps", "yellowfin"];
